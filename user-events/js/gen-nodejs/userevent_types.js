...
ttypes.NetworkStatus = {
'ONLINE' : 1,
'OFFLINE' : 2
};
Context = module.exports.Context = function(args) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.STRING) {
        this.containerName = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
      case 2:
      if (ftype == Thrift.Type.STRING) {
        this.stationIdentPlaying = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
...
EventData = module.exports.EventData = function(args) {
...
EventData.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRING) {
        this.stationIdent = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 3:
      if (ftype == Thrift.Type.STRING) {
        this.trackVersionId = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
...
BBMUserEvent = module.exports.BBMUserEvent = function(args) {
  this.timestamp = null;
  this.uuid = null;
  this.apikey = null;
  this.userId = null;
...
BBMUserEvent.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 6:
      if (ftype == Thrift.Type.I32) {
        this.networkStatus = input.readI32();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 8:
      if (ftype == Thrift.Type.STRUCT) {
        this.eventData = new ttypes.EventData();
...
BBMUserEventBatch = module.exports.BBMUserEventBatch = function(args) {
  this.userEvent = null;
  if (args) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem26 = null;
          elem26 = new ttypes.BBMUserEvent();
          elem26.read(input);
